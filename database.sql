-- NOTE: This dump remains backward-compatible with active legacy routes.
-- V2 additions are appended at the end so existing installations can import
-- the file without losing tables still referenced by the current UI.

-- Panel CEIR V2 schema additions
ALTER TABLE `layanan_digital`
  ADD COLUMN `public_visible` TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `provider_orders_v2` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
