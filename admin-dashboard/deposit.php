...
<div class="row">
    <div class="col-md-12">
        <br /><h2 class="text-center">Manajemen dan Laporan Data Deposit Lain Dana Member</h2><br/>
    </div>
</div>
<!-- End-Page-Title -->
        ...
        <div class="card widget-box-three">
            <div class="card-body">
                ...
                <div class="text-right">
                    <p class="text-uppercase font-14 m-b-10 font-600">Total Deposit Lain</p>
                    <h3 class="m-b-10"><span>Rp <?php echo number_format($data_deposit['total'],0,',','.'); ?> Dari <?php echo $jumlah_deposit_lain_member; ?> Deposit</span></h3>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>?id_deposit=<?php echo $data_depo['kode_deposit']; ?>" class="form-inline" role="form" method="POST"> 
                                    ...
                                    <td align="center">
                                        <a href="javascript:;" onclick="deposit('<?php echo $config['web']['url'];?>admin-dashboard/ajax/deposit/view-deposit?kode_deposit=<?php echo $data_depo['kode_deposit']; ?>')" class="btn btn-sm btn-primary"><i aria-hidden="true" class="fa fa-eye" title="view"></i></a>
