...
if (isset($_POST['update'])) {
    ...
    $cek_orders = $conn->query("SELECT * FROM pembelian_digital WHERE oid = '$get_oid'");
    ...
    if ($cek_orders->num_rows == 0) {
        ...
        if ($conn->query("UPDATE pembelian_digital SET status = '$status'  WHERE oid = '$get_oid'") == true){
    ...
    if ($cek_orders->num_rows == 0) {
        ...
        if ($conn->query("DELETE FROM pembelian_digital WHERE oid = '$get_oid'") == true){
            $_SESSION['hasil'] = array('alert' => 'success', 'judul' => 'Permintaan Berhasil', 'pesan' => 'Data Pesanan Berhasil Di Update 
                <br /> Order ID : '.$get_oid.'');
        }
    }
...
<div class="row">
    <div class="col-md-12">
        <br /><h2 class="text-center">Laporan Order dan Penjualan Produk Digital</h2><br/>
    </div>
</div>
<!-- End-Page-Title -->
        ...
        <div class="card widget-box-three">
            <div class="card-body">
                ...
                <div class="text-right">
                    ...
                    <h3 class="m-b-10"><span>Rp <?php echo number_format($data_pesanan_digital['total'],0,',','.'); ?> Dari <?php echo $jumlah_pesanan_digital; ?> Pesanan</span></h3>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="m-t-0 header-title"><b><i aria-hidden="true" class="fa fa-list"></i>    Pesanan Digital</b></h4>                             
                <form>
                    <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>?order_id=<?php echo $data_pesanan['oid']; ?>" class="form-inline" role="form" method="POST"> 
                                    ...
                                    <td align="center">
                                        <a href="javascript:;" onclick="pembelian_digital('<?php echo $config['web']['url'];?>admin-dashboard/ajax/order/view-digital?oid=<?php echo $data_pesanan['oid']; ?>')" class="btn btn-sm btn-primary"><i aria-hidden="true" class="fa fa-eye" title="view"></i></a>
...
<script type="text/javascript">
    function pembelian_digital(url) {
        $.ajax({
            type: "GET",
            url: url,
            beforeSend: function() {
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title mt-0" id="myModalLabel"><i class="mdi mdi-cart-outline"></i> Detail Pemesanan Digital</h4>
