...
// Production secrets should preferably be supplied through environment variables.
$config['db'] = [
    'host' => getenv('DB_HOST') ?: 'localhost',
    'name' => getenv('DB_NAME') ?: 'scard1544_ppob',
    'username' => getenv('DB_USERNAME') ?: 'scard1544_ppob',
    'password' => getenv('DB_PASSWORD') ?: 'scard1544_ppob',
];
