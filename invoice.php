...
if ($depo == 0) {  
	$_SESSION['hasil'] = array('alert' => 'danger', 'judul' => 'Deposit Pending Tidak Ditemukan', 'pesan' => 'Pilih Metode Pembayaran Untuk Mengisi Saldo');
...
<!--Title-->
<title>Invoice Deposit Bank</title>
			...
			<div class="card-body">
				<div class="clearfix">
					<div class="text-center">
						<h1 class="text-uppercase text-center header-title">Invoice #<?php echo $data_depo['kode_deposit']; ?></h1>
						<img src="/assets/images/pembayaran/kitadigital-deposit-bank.png" alt="Invoice" height="100">
						<img src="/assets/images/pembayaran/kitadigital-deposit-emoney.png" alt="Invoice" height="100">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="mt-3 text-md-right">
							...
							<p><b>Berita Transfer</b><br/><?php echo $data_depo['kode_deposit']; ?></p>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="clearfix pt-3">
							...
							<p>
								Lakukan pembayaran selambat-lambatnya 3 jam setelah faktur ini dibuat.<br/><br/>Silakan transfer sejumlah <b>Rp <?php echo number_format($data_depo['jumlah_transfer'],0,',','.'); ?></b>.
							</p>
							<p>
								Deposit di <span class="badge badge-danger"><b>Batalkan</b></span> otomatis jika melewati waktu. Saldo masuk <span class="badge badge-success"><b>Otomatis</b></span>.
							</p>
							<p>
								Deposit belum masuk hingga 10 menit? Konfirmasi via <a href="/tiket" target="_blank"><b> Tiket</b></a>.
							</p>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<!--Tombol ini dinonaktifkan, proses konfirm dan batal otomatis dari dpedia: lewat cek status deposit-->
				<div class="d-print-none m-t-30 m-b-30">
					<div class="text-right">
						<form method="POST">
							<input type="hidden" name="csrf_token" value="<?php echo $config['csrf_token'] ?>">
							<button class="btn btn-danger" name="cancel" disabled> BATALKAN </button>
						</form>
					</div>
				</div>
