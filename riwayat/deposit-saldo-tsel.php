...
<!--Title-->
<title>Riwayat Deposit via Tsel</title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="m-t-0 text-uppercase text-center header-title"><i aria-hidden="true" class="fa fa-history text-primary"></i><b> Riwayat Deposit via Tsel</b></h4><hr>
                        ...
                        <tbody>
                            <?php 
                                ...
                                if (isset($_GET['cari'])) {
                                    ...
                                    $cek_depo = "SELECT * FROM deposit_tsel WHERE kode_deposit LIKE '%$cari_id%' AND status LIKE '%$cari_status%' AND username = '$sess_username' ORDER BY id DESC"; // edit
                                    } else {
                                    $cek_depo = "SELECT * FROM deposit_tsel WHERE username = '$sess_username' ORDER BY id DESC"; // edit
                                    }
                                    if (isset($_GET['cari'])) {
                            ...
                            <tr>
                                ...
                                <td><button class="view_deposit btn btn-primary btn-small" data-toggle="modal" id="<?php echo $data_depo['id']; ?>" data-target='#myDetail'><i class="mdi mdi-view-list mdi-18px"></i></button><br /><br />
                                    <a href="<?php echo $config['web']['url'];?>invoice-pulsa" class="btn btn-<?php echo $klik; ?> <?php echo $btn; ?> btn-small"><i class="mdi mdi-<?php echo $action; ?> mdi-18px"></i></a>
                                </td>
                            </tr>   
                            <?php } ?>
                        </tbody>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.view_deposit').click(function(){
            ...
            // memulai ajax
            $.ajax({
                url: '<?php echo $config['web']['url'];?>riwayat/ajax/detail-deposit-tsel.php',
                method: 'post',		
                data: {id:id},	
