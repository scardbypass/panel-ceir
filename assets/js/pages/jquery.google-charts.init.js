...
! function($) {
    ...
    GoogleChart.prototype.init = function () {
        ...
        $this.createPieChart($('#pie-chart')[0], pie_data, ['#188ae2', '#4bd396', '#f6b309', '#f5707a', '#6b5fb5'], false, false);


        //creating donut chart
        $this.createDonutChart($('#donut-chart')[0], pie_data, ['#188ae2', '#4bd396', '#f6b309', '#f5707a', '#6b5fb5']);

        //creating 3d pie chart
        $this.createPieChart($('#pie-3d-chart')[0], pie_data, ['#188ae2', '#4bd396', '#f6b309', '#f5707a', '#6b5fb5'], true, false);
        ...
        $this.createPieChart($('#3d-exploded-chart')[0], sliced_Data, ['#188ae2', '#4bd396', '#f6b309', '#f5707a', '#6b5fb5'], true, true);
        ...
        $(window).on('resize', function() {
            ...
            $this.createColumnChart($('#column-chart')[0], column_data, 'Sales and Expenses', ['#4bd396', '#f5707a', '#27b2be']);
            $this.createBarChart($('#bar-chart')[0], bar_data, ['#4bd396', '#f5707a']);
            $this.createColumnStackChart($('#column-stacked-chart')[0], column_stacked_data, 'Sales and Expenses', ['#188ae2', '#4bd396', '#f6b309', '#f5707a', '#6b5fb5', '#27b2be']);
            $this.createBarStackChart($('#bar-stacked-chart')[0], bar_stacked_data, ['#188ae2', '#4bd396', '#f6b309', '#f5707a', '#6b5fb5', '#27b2be']);
            $this.createPieChart($('#pie-chart')[0], pie_data, ['#188ae2', '#4bd396', '#f6b309', '#f5707a', '#6b5fb5'], false, false);
            $this.createDonutChart($('#donut-chart')[0], pie_data, ['#188ae2', '#4bd396', '#f6b309', '#f5707a', '#6b5fb5']);
            $this.createPieChart($('#pie-3d-chart')[0], pie_data, ['#188ae2', '#4bd396', '#f6b309', '#f5707a', '#6b5fb5'], true, false);
            $this.createPieChart($('#3d-exploded-chart')[0], sliced_Data, ['#188ae2', '#4bd396', '#f6b309', '#f5707a', '#6b5fb5'], true, true);
